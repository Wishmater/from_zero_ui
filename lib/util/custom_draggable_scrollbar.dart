...
class DraggableScrollbar extends StatefulWidget {
  ...
  DraggableScrollbar.rrect({
    ...
    this.labelTextBuilder,
    this.labelConstraints,
    double scrollThumbElevation = 4,
    double scrollThumbWidth = 16,
    double scrollThumbBorderRadius = 7,
...
class ScrollLabel extends StatelessWidget {
  ...
  }) :  this.constraints = constraints ??  _defaultConstraints,
        super(key: key);
...
class _DraggableScrollbarState extends State<DraggableScrollbar>
  ...
  void initState() {
    ...
    WidgetsBinding.instance?.addPostFrameCallback((timeStamp) async{
      WidgetsBinding.instance?.addPostFrameCallback((timeStamp) async{
        double? scrollOffset;
        double barMaxScrollExtent = this.barMaxScrollExtent;
        try{ scrollOffset=widget.controller!.position.pixels; } catch (_) {}
  ...
  double _lastMaxScrollExtent = 720;
  double get barMaxScrollExtent {
    try {
      _lastMaxScrollExtent = context.size!.height;
    } catch(_) {}
    return _lastMaxScrollExtent - widget.heightScrollThumb;
  }

  double get barMinScrollExtent => 0.0;

  double get viewMaxScrollExtent => widget.controller?.position.maxScrollExtent ?? 0;

  double get viewMinScrollExtent => widget.controller?.position.minScrollExtent ?? 0;
  ...
  double getBarDelta(
    ...
    return (scrollViewDelta??0) * barMaxScrollExtent / viewMaxScrollExtent;
  }
