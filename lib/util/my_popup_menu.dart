...
double _kMenuHorizontalPadding = 16.0;
const double _kMenuDividerHeight = 16.0;
double _kMenuMaxWidth = 5.0 * _kMenuWidthStep; //280
double _kMenuMinWidth = 2.0 * _kMenuWidthStep; //112
double _kMenuVerticalPadding = 8.0;
...
class PopupMenuButton<T> extends StatefulWidget {
  ...
  PopupMenuButton({
    ...
    double? menuVerticalPadding,
        ...
        super(key: key) {
    if (menuHorizontalPadding!=null) _kMenuHorizontalPadding = menuHorizontalPadding;
    if (menuMaxWidth!=null) _kMenuMaxWidth = menuMaxWidth; //280
    if (menuMinWidth!=null) _kMenuMinWidth = menuMinWidth; //112
    if (menuVerticalPadding!=null) _kMenuVerticalPadding = menuVerticalPadding;
  }
