...
typedef Widget ButtonChildBuilder<T>(BuildContext context, String? title, String? hint, T? value);
...
typedef dynamic DAOGetter<T>(T value);    // TODO this should be DAO
                                          // TODO also standarize method to build a table from a List<DAO>, and use it in the combo
...
class _ComboFromZeroState<T> extends State<ComboFromZero<T>> {
  ...
  Widget build(BuildContext context) {
    ...
    if (widget.buttonChildBuilder==null) {
      ...
      child = ComboFromZero.defaultButtonChildBuilder(context, widget.title, widget.hint, value);
    } else {
      child = widget.buttonChildBuilder!(context, widget.title, widget.hint, widget.value);
    }
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        contentPadding: EdgeInsets.only(left: 16, right: 80, bottom: 4, top: 8,),
                        labelText: "Buscar...",
...
class DropdownChildLayoutDelegate extends SingleChildLayoutDelegate {
  ...
  Offset getPositionForChild(Size size, Size childSize) {
    if (referencePosition!=null && referenceSize!=null) {
      ...
      double y = referencePosition!.dy + referenceSize!.height;
